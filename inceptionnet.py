...
try:
    model = load_model('inc_model_0.h5', custom_objects={'f1_metric': f1_metric})
...
model_checkpoint = ModelCheckpoint('inc_model_0.h5', monitor='val_loss', save_best_only=True, verbose=1)
...
with open("inception_metrics_0.txt", "w") as file:
